...
version: "1.0.0"
user-invocable: true
description: "Remove AI writing patterns from primarily English text (Wikipedia Signs of AI writing). Use when humanizing, de-slopping, or naturalizing prose. Triggers — 「去AI痕迹」「人性化改写」「humanize」「remove AI writing」「humanizer」. Do NOT use for Chinese-primary text (humanizer-zh), tech-review docs (tech-review-doc), or marketing articles (article-writer)."
---

# Humanizer: Remove AI Writing Patterns

> **Upstream:** Adapted from [blader/humanizer](https://github.com/blader/humanizer) (MIT). Patterns based on [Wikipedia: Signs of AI writing](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing). See `LICENSE`.
