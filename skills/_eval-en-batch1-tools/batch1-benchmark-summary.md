...
| jira-fix-queue | 67% | 56% | +11% |
| opsx-jira-fix-queue | 89% | 33% | +56% |
...
- `jira-fix-queue` EN removes hardcoded platform loop commands (`ulw-loop`/`ralph`) — intentional platform-agnostic improvement; heuristic may score old higher on orchestration wording.
