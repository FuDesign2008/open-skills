...
**Reason**: Optional soft discovery does not guarantee invocation; hosts use strong dependencies only.
...
**Reason**: No host shall reference this skill after removal.
...
**Reason**: Hosts no longer perform optional enhancement mapping.
