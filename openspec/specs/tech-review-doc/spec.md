# tech-review-doc Specification

## Purpose
Generate product/QA-facing technical review markdown from a design document, with §1 approval gate and template-based structure.
