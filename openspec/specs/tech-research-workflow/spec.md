# tech-research-workflow Specification

## Purpose

Behavioral contract for the `tech-research-workflow` skill: evidence-driven technology/competitor research that ends in a decision-ready report family. Orders research before design (self business audit → competitor first-hand research → design mapping), binds claims to tiered evidence, treats the first report version as a constraint probe, and offers a lean path for single-question research.
