# solution-review Specification

## Purpose

Behavioral contract for the `solution-review` skill: decision-level review gates, including cost-vs-value under cheap implementation and architectural elegance vs long-term maintainability.
