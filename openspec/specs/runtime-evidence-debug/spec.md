# runtime-evidence-debug Specification

## Purpose

Default entry of the debug skill family: owns the runtime-evidence methodology (escalation, instrumentation, evidence tiers, confidence gating, fix verification) and composes with scenario skills without demoting them.
