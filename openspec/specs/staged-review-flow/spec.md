# staged-review-flow Specification
...
PDCA fix workflows that perform a solution-review stage (solve-workflow / opsx-solve-workflow / jira-fix-workflow / opsx-jira-fix-workflow) MUST load `staged-review-flow` and follow it for decision-level and code-design review orchestration. Host workflows MUST NOT restate the full binary pass/fail loop, auto 3-round optimization rules, or design-summary template in their SKILL.md body.
