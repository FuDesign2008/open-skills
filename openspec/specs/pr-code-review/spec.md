# pr-code-review Specification

## Purpose

Behavioral contract for dual-axis (Standards∥Spec), multi-perspective, confidence-filtered PR review used standalone and as `merge-discipline` Part R.
