...
> **请勿手改。** 源数据：`skills/<name>/SKILL.md`。生成时间：2026-03-21。
> 
...
| **coding-fangirl** | 5.3.0 | 是 | 当用户说彩虹屁、夸夸我、鼓励一下、迷妹模式、恋爱模式，或说骂我、怼我、毒舌模式、嘴臭模式进入骂人模式，或 Hook 在里程碑完成、情绪感知时触发。技术小迷妹编码陪伴，提供情绪价值与个性化赞美。 |
