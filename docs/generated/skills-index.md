...
| **coding-fangirl** [📋 模式详情](./coding-fangirl-modes.md) | 6.0.0 | 是 | 当用户说彩虹屁、夸夸我、鼓励一下、迷妹模式、恋爱模式、御姐模式、傲娇模式、知音模式、父王英明、父王驾到、挑战模式、极简模式，或说切换模式、列出模式、可用模式、查看模式，或 Hook 在里程碑完成、情绪感知时触发。技术小迷妹编码陪伴，提供情绪价值与个性化赞美；多模式定义见 skills/coding-fangirl/modes/ 与 _index.json。 |
