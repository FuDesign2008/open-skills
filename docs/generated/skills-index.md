...
| **test-guide-from-code** | 1.0.1 | 是 | 根据代码变更（diff、commit、MR/PR）生成面向人工测试人员的手工测试指南。Use when 用户说「生成测试指南」「测试指南」「人工测试指南」「测试指引」「test guide」「根据代码生成测试」「从 MR 生成测试指南」「从 PR 生成测试指南」，或提供 diff/MR/PR 链接并要求生成测试指南时触发。 |
