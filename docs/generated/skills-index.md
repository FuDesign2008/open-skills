...
> **请勿手改。** 源数据：`skills/<name>/SKILL.md`。生成时间：2026-05-15。
> 
...
| **think-big** | 1.0.0 | 是 | 战略性思考框架，帮助从时间轴、系统、取舍、不确定性四个维度分析工作中的任何一件事。当用户说「战略思考」「战略分析」「从战略角度看」「战略视角」「帮我想清楚这件事」「这件事值不值得做」「从更高视角分析」「think-big」「strategic thinking」「strategy」时触发。支持快速模式（4维分析）和深度模式（苏格拉底追问）。 |
